  ...
  const startRecording = useCallback(async () => {
    try {
      ...
      if (err instanceof DOMException && err.name === "NotAllowedError") {
        setError(
          "Acceso denegado al micrófono. Por favor permita el uso de micrófono en la configuración de tu navegador.",
        );
      } else {
        setError("Fallo al acceder a tu micrófono. Por favor revisa tu dispositivo.");
      }
    }
  }, [cleanup]);
