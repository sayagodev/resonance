...
const voiceCreateFormSchema = z.object({
  ...
  file: z
    .instanceof(File, { message: "Un archivo de audio es requerido" })
    .nullable()
    .refine((f) => f != null, "Un archivo de audio es requerido"),
  category: z.string().min(1, "Una categoría es requerida"),
  language: z.string().min(1, "Un idioma es requerido"),
    ...
    >
      ...
      <div className="flex flex-col items-center gap-1.5">
        ...
        <p className="text-center text-sm text-muted-foreground">
          Todos los formatos de audio soportados, máximo 20MB
        </p>
      </div>
      ...
      <PopoverTrigger asChild>
        ...
        >
          <div className="flex items-center gap-2 truncate">
            ...
            {value ? selectedLabel : "Seleccionar idioma..."}
          </div>
  ...
  const createMutation = useMutation({
    mutationFn: async ({
      ...
      if (!response.ok) {
        ...
        throw new Error(body.error ?? "Error al crear la voz")
      }
