...
export function DashboardSidebar() {
  ...
  const otherMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      url: "mailto:contacto@sayago.dev",
      icon: Headphones,
    }
  ];
  ...
  return (
    <Sidebar collapsible="icon">
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <OrganizationSwitcher
              ...
              appearance={{
                elements: {
                  rootBox: "w-full! group-data-[collapsible=icon]:w-auto! group-data-[collapsible=icon]:flex!",
                  organizationSwitcherTrigger: "w-full! justify-between! bg-white! border! border-border! rounded-md! pl-1! pr-2! py-1! gap-3! group-data-[collapsible=icon]:w-auto! group-data-[collapsible=icon]:p-1! shadow-[0px_1px_1.5px_0px_rgba(44,54,53,0.03)] outline-none select-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/50",
      ...
      <SidebarContent>
        ...
        <NavSection label="Otros" items={otherMenuItems} pathname={pathname} />
      </SidebarContent>
            ...
            <UserButton
              ...
              appearance={{
                elements: {
                  ...
                  userButtonTrigger:
                    "w-full! justify-between! bg-white! border! border-border! rounded-md! pl-1! pr-2! py-1! shadow-[0px_1px_1.5px_0px_rgba(44,54,53,0.03)]! group-data-[collapsible=icon]:w-auto! group-data-[collapsible=icon]:p-1! group-data-[collapsible=icon]:after:hidden! [--border:color-mix(in_srgb,transparent,var(--clerk-color-neutral,#000000)_15%)]! outline-none select-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/50",
